...
\begin{center}
	\begin{tikzcd}
		\mathrm{Prop} \times p \arrow[rrd, "\mathrm{Or.intro\_left}"]   &  &          &                                                                             &  &   \\
		&  & p \lor q & (p \lor q) \times (p \to r) \times (q \to r) \arrow[rr, "\mathrm{Or.elim}"] &  & r \\
		\mathrm{Prop} \times q \arrow[rru, "\mathrm{Or.intro\_right}"'] &  &          &                                                                             &  &  
	\end{tikzcd}
\end{center}
...
\begin{center}
	\begin{tikzcd}
		&  &                                                                                     &  & p \to q \\
		(p \to q) \times (q \to p) \arrow[rr, "\mathrm{Iff.intro}"] &  & p \leftrightarrow q \arrow[rru, "\mathrm{Iff.mp}"] \arrow[rrd, "\mathrm{Iff.mpr}"'] &  &         \\
		&  &                                                                                     &  & q \to p
	\end{tikzcd}
\end{center}
